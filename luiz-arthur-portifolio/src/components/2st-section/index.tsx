import './styles.css';
import TopographicBackground from './TopographicBackground.js';
...
export default function SecondSection() {
  return (
    ...
    <div className='second-section-container-2'>
        <div className='second-section-container-2-flex'>
            <h2 className="second-section-title">Sobre mim</h2>
            <p className='second-section-text'>
            <span className='simulated-html'>{"<p>"}</span>
            <br/>
            <strong className='second-section-text-strong'>Olá, tudo bem?</strong>
            <br/><br/>
            Meu nome é Luiz Arthur, sou um desenvolvedor que utiliza{' '}
            <strong className='second-section-text-strong-2'>HTML</strong>,{' '}
            <strong className='second-section-text-strong-2'>CSS</strong>,{' '}
            <strong className='second-section-text-strong-2'>JS/TS</strong>, e{' '}
            <strong className='second-section-text-strong-2'>REACT</strong> no front-end,

            e {' '}

            <strong className='second-section-text-strong-2'>PYTHON</strong>,{' '}
            <strong className='second-section-text-strong-2'>NODE.JS</strong>,{' '}
            <strong className='second-section-text-strong-2'>POSTGRES</strong>, e{' '}
            <strong className='second-section-text-strong-2'>SQL</strong> no back-end.

            <br/>

            {' '}Além disso, sou uma pessoa altamente motivada e otimista, dedicada a escrever código limpo, eficiente e que realmente funciona, sempre buscando evoluir e nunca parar de aprender.
            <br/> Quando não estou codando, estou jogando games, praticando esportes ou viajando e explorando novos lugares pelo mundo.
            Gosto de ser desafiado em minhas perspectivas e crenças, pois é assim que enxergo o mundo com outros olhos.
            <br/>
            <span className='simulated-html'>{"</p>"}</span>
            </p>
        </div>
        <img src="/section-2-image.png" alt="Imagem desenvolvedor trabalhando" className='second-section-container-2-image' />
    </div>
    </div>
    </section>
    </>
