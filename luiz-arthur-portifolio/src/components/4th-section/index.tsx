...
const projects = [
  {
    ...
    image: "/Mocks/mock-cafe-orfeu.png",
    alt: "Café Orfeu",
  ...
  },
  {
    ...
    linkLabel: "Veja o website",
    image: "/Mocks/mock-west-coast.png",
    alt: "Recco",
    ...
    <>
      <section className='fourth-section' id="projetos">
        ...
        <div>
          ...
          <h1 className='third-section-title'>Projetos</h1>
          ...
          <p className='fourth-section-description'>Projetos que desenvolvi ao longo da minha trajetória, combinando experiências profissionais e iniciativas próprias.</p>
        </div>

        <div className='fourth-section-projects-container'>
          <div className="carousel-wrapper">

            <button className="carousel-arrow carousel-arrow-left" onClick={prev} aria-label="Projeto anterior">
              <span className="carousel-arrow-chevron" />
            </button>

            <div className="carousel-card" key={current}>
              <a href={project.link} target="_blank" rel="noopener noreferrer" className="carousel-link fourth-section-project-link">
                {project.linkLabel}
                <ArrowIcon />
              </a>
              <img
              ...
              <p className="carousel-card-text">{project.text}</p>
            </div>

            <button className="carousel-arrow carousel-arrow-right" onClick={next} aria-label="Próximo projeto">
              <span className="carousel-arrow-chevron" />
            </button>
